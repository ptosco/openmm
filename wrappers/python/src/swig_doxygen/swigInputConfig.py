...
SKIP_METHODS = [('State', 'getPositions'),
                ...
                ('CalcMMFFBondForceKernel',),
                ('CalcMMFFAngleForceKernel',),
                ('CalcMMFFTorsionForceKernel',),
                ('CalcMMFFStretchBendForceKernel',),
                ('CalcMMFFOutOfPlaneBendForceKernel',),
                ('CalcMMFFVdwForceKernel',),
                ('CalcMMFFNonbondedForceKernel',),
...
("SerializationNode", "getCharProperty") : (None, ()),
