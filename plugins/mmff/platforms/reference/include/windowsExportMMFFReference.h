 ...
 */
    ...
    #if defined(OPENMM_MMFF_REFERENCE_BUILDING_SHARED_LIBRARY)
        #define OPENMM_MMFF_REFERENCE_EXPORT __declspec(dllexport)
    #elif defined(OPENMM_MMFF_REFERENCE_BUILDING_STATIC_LIBRARY) || defined(OPENMM_MMFF_REFERENCE_USE_STATIC_LIBRARIES)
        #define OPENMM_MMFF_REFERENCE_EXPORT
    #else
        #define OPENMM_MMFF_REFERENCE_EXPORT __declspec(dllimport)   // i.e., a client of a shared library
    #endif
#else
    #define OPENMM_MMFF_REFERENCE_EXPORT // Linux, Mac
#endif
